...
function assertValidEntryLength(entryLength, imageOffset, fileLength, inputLength) {
    if (entryLength < SIZE_HEADER ||
        imageOffset + entryLength > fileLength ||
        imageOffset + entryLength > inputLength) {
...
exports.ICNS = {
    ...
    calculate(input) {
        ...
        assertValidEntryLength(imageHeader[1], imageOffset, fileLength, inputLength);
