...
- `version`: 1.0.31
- Closed Testing release vC60 is validated locally and is submitted only after the protected merge and GitHub release publication. Availability remains controlled by Google Play review and tester eligibility.
