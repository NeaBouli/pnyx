...
- GH#111 focused tests exist: `tests/test_identity_nullifier_v2_endpoint.py` proves same-row v1->v2 migration with mocked HLR; focused set passed `23 passed, 1 skipped`.
