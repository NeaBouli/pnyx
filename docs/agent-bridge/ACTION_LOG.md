...
- Change:
  - fdroiddata commit `c23b4b2cd7` split `ekklesia.gr` into four ABI-specific builds:
    - `511` `armeabi-v7a`
    - `512` `arm64-v8a`
    - `513` `x86`
    - `514` `x86_64`
...
- Scope:
  - Gio requested a new `vC40` with a new version number; `vC40` is older than the current Play/source lineage, so the safe monotonic release is `vC50 / v1.0.21`.
  - No Vote/ZK/Identity runtime logic changed in this release bump.
- Changed:
  - `apps/mobile/app.json`: `version=1.0.21`, `android.versionCode=50`.
  - `apps/mobile/android/app/build.gradle`: `versionName "1.0.21"`, `versionCode 50`.
  - `apps/api/routers/app_version.py`: latest version endpoint bumped to `1.0.21 / 50`.
  - `docs/index.html`: visible APK badge bumped to `v1.0.21 · vC50`.
  - `docs/download/APK_MANIFEST.md` and `docs/download/ekklesia-latest.apk.sha256` updated.
- Artifacts:
  - AAB: `/Users/gio/Desktop/ekklesia-v1.0.21-vC50-PLAY.aab`, SHA256 `709cb2cee17f30f48ed417ecda9e1b8831f1b61a446286292a61f1454e3ad5e6`.
  - APK: `/Users/gio/Desktop/ekklesia-v1.0.21-vC50-PLAY.apk`, SHA256 `989c5f92ff37b4a8498e6410f362dedbfd91e362042ec5e6685479385c14685d`.
- Verification:
  - `python -m py_compile apps/api/routers/app_version.py`: PASS.
  - `npx --prefix apps/mobile tsc --noEmit -p apps/mobile/tsconfig.json`: PASS.
  - `cd apps/mobile && npx vitest run`: PASS, 86 passed.
  - `bash scripts/build-play.sh`: PASS.
  - AAB manifest: package `ekklesia.gr`, `versionCode=50`, `versionName=1.0.21`.
...
- Verification:
  ...
  - API container rebuilt on server with rollback tag `rollback-pre-gh111-row-lock-20260617-034548`.
  ...
  - Saved live artifacts:
    - `/opt/ekklesia/backups/gh111_preflight/gh111_before_snapshot_7ec51da_20260617_034623.json`, SHA256 `d8e4043d4b6e4c7b93ec9a473004f247b0f80f624c97f9df640e484f9a35c3a1`.
    - `/opt/ekklesia/backups/gh111_preflight/gh111_preflight_report_7ec51da_20260617_034623.json`, SHA256 `0953ee0ce43f662d024616ac572fe34a469f33d9645e4b4532e6f5800d1cb24a`.
...
- Verification:
  ...
  - Invariant helper deployed with rollback tag `rollback-pre-gh111-invariant-helper-20260617-032058`.
  - Live invariant preflight: PASS, `active_with_v2=0`, `v2_without_version=0`, `version_without_v2=0`, `malformed_v2=0`.
  - Saved live artifacts:
    - `/opt/ekklesia/backups/gh111_preflight/gh111_before_snapshot_e78cee8_20260617_031234.json`, SHA256 `874c883d00435db3a56e5aadbff379aa13a2d580b6d004cafc8a7db86965e461`.
    - `/opt/ekklesia/backups/gh111_preflight/gh111_preflight_report_e78cee8_20260617_031234.json`, SHA256 `8788317f5b8be1bbda9ef02299291975ff6c835346399e172fd3082b8e881034`.
    - `/opt/ekklesia/backups/gh111_preflight/gh111_before_snapshot_033ceb4_20260617_032135.json`, SHA256 `d8e4043d4b6e4c7b93ec9a473004f247b0f80f624c97f9df640e484f9a35c3a1`.
    - `/opt/ekklesia/backups/gh111_preflight/gh111_preflight_report_033ceb4_20260617_032135.json`, SHA256 `0953ee0ce43f662d024616ac572fe34a469f33d9645e4b4532e6f5800d1cb24a`.
  - Live monitor once after API rebuild: PASS, 17 checks, no alerts.
- Safety boundary:
  - GH#111 remains open/waiting for an explicit real phone/HLR operator canary.
  - Do not activate `IDENTITY_NULLIFIER_KDF_VERSION=v2` from DB/admin-test data alone.
...
- Server runtime findings:
  ...
  - Targeted project scan: `/opt/parlay`, `/opt/vlabs`, `/opt/stealthx`, `/opt/inferno`, and `/opt/plausible` had no Ollama/qwen references.
