...
- [x] vC45 Play/direct release: AAB/APK built, hashes verified, S10 install/launch passed, verified-account state preserved, GitHub release/deploy pending in current task.
