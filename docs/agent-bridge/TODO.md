...
- [ ] NEA-272e: Mobile POLIS Tab aktivieren (Option C MVP). `TicketsScreen.tsx` zeigt weiterhin Phase-B/Coming-Soon Modal fuer `+ Νέο Ticket` und Votes. Fix: Coming-Soon durch klaren Browser-Flow ersetzen: `https://ekklesia.gr/tickets/index.html` oeffnen, Mobile bleibt QR-Authenticator. Nur Debug APK auf S10, kein version bump/public Release.
