...
0. [ ] Lifecycle Catch-up No-Skip — GH#113 / NEA-389
   ...
   - Offen: Review, commit/push/deploy API+monitor, live monitor run, Bridge/TODO/GitHub/Linear Abschluss.
...
- Active GitHub truth remains: `#79` F-Droid, `#80` Off-site Backup, `#112` ZK V2 staged/global follow-up, `#113` lifecycle catch-up no-skip.
