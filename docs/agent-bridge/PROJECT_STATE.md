...
- **Repo HEAD:** `d67b9c2` (GH#112 admin canary preflight)
- **API container:** API-only deploy includes GH#112 canary isolation + hidden `ZK-CANARY-001`; ZK endpoints remain fail-closed
