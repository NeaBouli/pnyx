...
- **GH#111 S10 UI Path:** vC45 Profile -> `Επαλήθευση / Νέο κλειδί` -> VerifyScreen verified on S10 without submit/HLR; DB invariant after test: 17 active identities, 0 v2 rows, KDF unset.
