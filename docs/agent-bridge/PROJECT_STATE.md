...
- **F-Droid !38007:** Still open/mergeable. Sed feedback was addressed in fdroiddata commit `2bf46a733` and pipeline `2630143862` passed. Latest linsui ABI feedback is addressed in fdroiddata commits `c23b4b2cd7` + `116cbe6a23` + `f11a3c605e`: four ABI-specific builds `511-514`, `abiFilters`, `mips/mips64` removal, `VercodeOperation`, `CurrentVersionCode=514`, then CI `rewritemeta` normalization. Pipelines `2634045842` and `2634051871` failed only formatter comparison before the CI-normalization follow-up; new pipeline `2634059166` is running. #79 waits on pipeline + linsui/F-Droid review + merge.
