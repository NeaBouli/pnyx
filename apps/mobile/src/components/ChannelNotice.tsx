...
const MESSAGES = {
  ...
  fdroid: {
    body: "Εγκαταστήσατε την εκκλησία μέσω F-Droid.\n\nℹ️ Οι ενημερώσεις πρέπει να εγκαθίστανται από το F-Droid. Η άμεση APK και η έκδοση Google Play έχουν διαφορετική υπογραφή και απαιτούν πρώτα απεγκατάσταση.",
  },
} as const;
