...
const s = StyleSheet.create({
  ...
  compassGrid: { alignItems: "center", marginVertical: 16, paddingHorizontal: 16 },
  compassInner: { flexDirection: "row", alignItems: "center", width: "100%" },
  compassBox: { flex: 1, aspectRatio: 1, maxWidth: 300, borderWidth: 1, borderColor: colors.border, borderRadius: 8, position: "relative", overflow: "visible" },
  ...
  partyDot: { position: "absolute", width: 12, height: 12, borderRadius: 6, marginLeft: -6, marginBottom: -6 },
  partyLabel: { position: "absolute", top: -12, left: 14, fontSize: 9, fontWeight: "800", color: colors.textSecondary, width: 50 },
  userDot: { position: "absolute", width: 18, height: 18, borderRadius: 9, backgroundColor: colors.primary, marginLeft: -9, marginBottom: -9, borderWidth: 3, borderColor: "#fff", shadowColor: colors.primary, shadowRadius: 6, shadowOpacity: 0.5, elevation: 4 },
  axisLabelTop: { fontSize: 11, color: colors.textTertiary, marginBottom: 4 },
  axisLabelBottom: { fontSize: 11, color: colors.textTertiary, marginTop: 4 },
  axisLabelLeft: { fontSize: 11, color: colors.textTertiary, marginRight: 8, width: 50, textAlign: "right" },
  axisLabelRight: { fontSize: 11, color: colors.textTertiary, marginLeft: 8, width: 50 },
  ...
  matchName: { width: 90, fontSize: 12, fontWeight: "700", color: colors.text },
