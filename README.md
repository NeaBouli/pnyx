...
| ZK Voting V2 | Optional Semaphore-based anonymous proofs | Scoped production-ready after security review; global rollout gated |
...
| **V2** | ZK Voting (Semaphore) + Federation | Scoped production-ready; global rollout gated |
